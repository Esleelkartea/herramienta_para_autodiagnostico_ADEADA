...
/* include: salvar.php
/* Theme: adeada
/* Descripción: Guarda en la BD los valores del cuestionario
/*
...
function guardar(){
	...
	$strTabla =  "<p>&nbsp;</p><table><tr><th>Estrategia</th><th>Personas</th><th>Recursos</th><th>Procesos</th><th>Resultados</th><th>Total</th></tr><tr>".$strTabla."</tr></table>";
	...
	if ($_POST["estado_cuestinario"] == "1"){
		...
		if (($puntos >= 100) && ($puntos < 200)){
			$strDiag =  $strDiag."<div class='informe3'><img src='wp-content/plugins/adeada/test/images/bronce.jpg'/><br/>Su empresa ha alcanzado un <strong>Nivel B&aacute;sico: Iniciaci&oacute;n a la Excelencia</strong></div>";
